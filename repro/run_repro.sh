...
mkdir -p .repro_tmp/l_theory_assembly_conjecture
cp artifacts/stitch_constants.json .repro_tmp/l_theory_assembly_conjecture/stitch_constants.json
cp artifacts/constants_registry.json .repro_tmp/l_theory_assembly_conjecture/constants_registry.json
python3 scripts/lta_closure_guard.py --strict-coh-zero --registry artifacts/constants_registry.json --stitch artifacts/stitch_constants.json --out repro/certificate_runtime.json --history repro/drift_guard_runs.jsonl --pretty
