...
mkdir -p .codex_tmp/l_theory_assembly_conjecture
cp artifacts/stitch_constants.json .codex_tmp/l_theory_assembly_conjecture/stitch_constants.json
cp artifacts/constants_registry.json .codex_tmp/l_theory_assembly_conjecture/constants_registry.json
