...
Canonical Lane research workspace for a flagship problem in surgery theory, K-theory, and L-theory:
proving assembly persistence for quadratic signatures and L-theory spectra through an admissible assembly closure architecture.

## Main Manuscript

- [paper/L_THEORY_ASSEMBLY_CONJECTURE_PREPRINT.md](paper/L_THEORY_ASSEMBLY_CONJECTURE_PREPRINT.md)
- [paper/CANONICAL_ROUTING_INDEX.md](paper/CANONICAL_ROUTING_INDEX.md)

## Structure

- `paper/`
  - `L_THEORY_ASSEMBLY_CONJECTURE_PREPRINT.md`
...
1. Theorem chain first: read `paper/L_THEORY_ASSEMBLY_CONJECTURE_PREPRINT.md`.
...
Current LTA runner policy:

- `repro/run_repro.sh` extracts, promotes, runs `scripts/lta_closure_guard.py`, updates `repro/repro_manifest.json`, and enforces `fully_extracted` release-gate mode.
...
3. artifact key consumed by `scripts/lta_closure_guard.py`.
...
- Manuscript target: [paper/L_THEORY_ASSEMBLY_CONJECTURE_PREPRINT.md](paper/L_THEORY_ASSEMBLY_CONJECTURE_PREPRINT.md)
